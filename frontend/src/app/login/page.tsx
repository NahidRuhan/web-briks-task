      ...
      >
        <div className="p-2 rounded-[2.5rem] bg-zinc-100/80 border border-zinc-200/60 shadow-sm">
          <div className="bg-white rounded-4xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-zinc-100 p-8 sm:p-10">
            <h2 className="mb-8 text-center text-[22px] font-medium text-zinc-900 tracking-tight">Sign in to your account</h2>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="relative mt-8 mb-6">
                ...
                <div className="relative flex justify-center text-xs uppercase tracking-widest">
                  <span className="bg-white px-4 text-zinc-400 font-semibold">Demo Login As</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-3">
                <button
                  ...
                  disabled={loading}
                  className="flex items-center justify-center rounded-xl border border-zinc-200 bg-white py-2.5 text-[14px] font-medium text-zinc-600 hover:bg-zinc-50 hover:text-zinc-900 hover:border-zinc-300 transition-all duration-300 ease-(--ease-spring) active:scale-[0.97] focus:outline-none focus:ring-4 focus:ring-zinc-100 disabled:opacity-50"
                >
                  Nahid
                </button>
                <button
              ...
              <div className="text-center pt-4">
                <Link href="/register" className="text-[14px] font-medium text-zinc-500 transition-colors hover:text-zinc-900 underline underline-offset-4 decoration-zinc-300 hover:decoration-zinc-900">
